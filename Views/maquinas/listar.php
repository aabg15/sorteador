...
<div id="layoutSidenav_content">
  <main>
    <div class="container-fluid">
      <h5 class="text-center">Imágenes del Sorteador</h5>
      <div class="row">
        <div class="col-lg-12">
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td><img class="img-thumbnail" src="<?php echo base_url() ?>ruleta/img/<?php echo $autor['img']; ?>" width="100"></td>
                    <td><?php echo $autor['destino']; ?></td>
                    <td><?php echo $estado; ?></td>

                    <td>
                      <a class="btn btn-primary" href="<?php echo base_url() ?>maquinas/editar?id=<?php echo $autor['id'] ?>"><i class="fas fa-edit"></i></a>

                      <?php if ($autor['estado'] == 0) { ?>

                        <form method="post" action="<?php echo base_url() ?>maquinas/eliminar" class="d-inline eliminar">
                        ...
                        <form action="<?php echo base_url() ?>maquinas/reingresar" method="post" class="d-inline reingresar">
                          <input type="hidden" name="id" value="<?php echo $autor['id']; ?>">
