            ...
            <div class="col-lg-5">
              <div class="card border-0 rounded-lg mt-5 sb-sidenav-dark">
                <div class="card-header text-center ">
                  ...
                  <img class="img-thumbnail" src="<?php echo base_url(); ?>Assets/img/error.png" width="150">
                ...
                <div class="card-body">
                  <center>
                    ...
                    <a class="navbar-brand" href="<?php echo base_url(); ?>">
                      Volver<img src="<?php echo base_url(); ?>Assets/img/sullana.png" width="200" style="filter: brightness(1.1); mix-blend-mode: multiply;" id="img_nav">
                    </a>
                  </center>
