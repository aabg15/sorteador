...
$sqlData = "SELECT * from fondo where estado =1";
...
//creo el css
$css = "background-color: #ff8000 !important;background-image: url('$ruta');";
            ...
            <div class="col-lg-5">
              <div class="card border-0 rounded-lg mt-5 sb-sidenav-dark">
                <div class="card-header text-center ">
                  <h3 class="font-weight my-4">Acceso</h3>
                  <img class="img-thumbnail" src="<?php echo base_url(); ?>Assets/img/sullana.png" width="150">
                </div>
                <div class="card-body">
                  <form action="<?php echo base_url(); ?>Usuarios/login" method="post" autocomplete="off">
                    ...
                    <button class="btn btn-primary1 btn-block" type="submit">INICIAR SESION</button>
